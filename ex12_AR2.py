...
def example_aruco():
    ...
    R = tools_GL3D.render_GL3D(filename_obj='./images/ex_GL/box/box.obj', W=frame.shape[1], H=frame.shape[0], scale=(marker_length/2,marker_length/2,marker_length/100))
...
def example_face():
    ...
    L3D = numpy.array(R.obj.coord_vert, dtype=numpy.float)
...
def example_cube():
    ...
    image_3d = R.get_image((0,0.8,0), (0,0,+10))
    cv2.imwrite('./images/output/cube_GL.png', image_3d)
