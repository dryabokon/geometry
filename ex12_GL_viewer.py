...
def event_position(window, xpos, ypos):
    ...
    if R.on_append == True:
        ...
        if tvec is not None:
            R.my_VBO.append_object(filename_sphere, (0.7, 0.2, 0), do_normalize=True, svec=(0.025, 0.025, 0.025), tvec=tvec)
            R.bind_VBO()
...
if __name__ == '__main__':
    ...
    R = tools_GL3D.render_GL3D(filename_obj=filename_head, W=W, H=H)
