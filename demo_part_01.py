import cv2
import numpy
import tools_draw as Draw
import tools_calibrate as Calibrate
import math
#--------------------------------------------------------------------------------------------------------------------------
def example_01_calibrate_camera():

    folder_input_chess      = 'D:/Projects/Cyb/Stereo/ex01/left/'
    filename_input_chess    = 'D:/Projects/Cyb/Stereo/ex01/left/left01.jpg'
    filename_input_grid     = 'D:/Projects/Cyb/Stereo/ex01/grid.jpg'
    filename_output_chess   = 'D:/Projects/Cyb/Stereo/ex01_out/undistorted_chess.jpg'
    filename_output_grid    = 'D:/Projects/Cyb/Stereo/ex01_out/undistorted_grid.jpg'

    chess_rows=6
    chess_cols=7

    cameraMatrix, dist = Calibrate.get_proj_dist_mat_for_images(folder_input_chess,chess_rows,chess_cols)
...
def example_02_rectify_pair():
    ...
    folder_input      = 'D:/Projects/Cyb/Stereo/ex01/left/'
    filename_input_1  = 'D:/Projects/Cyb/Stereo/ex01/left/left01.jpg'
    filename_input_2  = 'D:/Projects/Cyb/Stereo/ex01/right/right01.jpg'
    filename_output_1 = 'D:/Projects/Cyb/Stereo/ex01_out/left01_rect.jpg'
    filename_output_2 = 'D:/Projects/Cyb/Stereo/ex01_out/right01_rect.jpg'

    chess_rows=6
    chess_cols=7

    cameraMatrix, dist = Calibrate.get_proj_dist_mat_for_images(folder_input,chess_rows,chess_cols)

    im1_remapped, im2_remapped = Calibrate.rectify_pair(cameraMatrix, dist, filename_input_1, filename_input_2, chess_rows, chess_cols)
