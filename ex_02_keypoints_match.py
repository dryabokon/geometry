...
# ---------------------------------------------------------------------------------------------------------------------
def example_find_matches(detector='SIFT', matchtype='knn'):
	folder_input = '_images/ex02/'
	...
	match1, match2, distance = tools_calibrate.get_matches_from_keypoints_desc(points1, des1, points2, des2, matchtype)
...
if __name__ == '__main__':
	example_find_matches('ORB', 'knn')
	example_find_matches('ORB', 'flann')
	example_find_matches('ORB', 'xxx')

	example_find_matches('SIFT', 'knn')
	example_find_matches('SIFT', 'flann')
	example_find_matches('SIFT', 'xxx')

	example_find_matches('SURF', 'knn')
	example_find_matches('SURF', 'flann')
	example_find_matches('SURF', 'xxx')
