...
def storage_calibration_result(vp1, vp2, vp3, forcal, M_r_o2c, V_t_o2c, img_name):
    vps = [vp1, vp2, vp3]
    with open(folder_out + str(img_name) + 'CalibrationResult.txt', "w") as f:
...
def main(image_path, px_x, px_y, h, contrast=5, sharpness=10, sigma=5, iterations=3000, line_len=11, line_gap=7,threshold: 'float' = 2):
    ...
    fig_name = folder_out + '{}_inliers_iter{}_thresh{}_sigma{}_hlen{}_hgap{}.png' .format(img_name, iterations, threshold, sigma, line_len, line_gap)
    colors = ['r', 'g', 'b']
    visualize_inliers(image, enhanced_ski, edges, lines, inlier_lines_list, colors, fig_name=fig_name)
    fig_name = folder_out + '{}_vanishing_point_iter{}_thresh{}_sigma{}_hlen{}_hgap{}.png'.format(img_name, iterations, threshold, sigma, line_len, line_gap)
    visualize_vanishing_points(best_hypothesis_1, best_hypothesis_2, best_hypothesis_3,image, lines, edges, inlier_lines_list, colors, fig_name)
...
if __name__ == '__main__':
    main('./images/ex_lines/rt1.jpg',1226,2366,1.8)
    #main('./images/ex_BEV/_0000000000.png', 631,166,1.8)
    #main('./images/ex_BEV/KZ.jpg',  1080,706,2)
    #main('./images/ex_bgrem/_001330.jpg',  1080,706,2)