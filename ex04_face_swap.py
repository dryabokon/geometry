...
#default_filename_in  = './images/ex_faceswap/02/frame001685.jpg'
#default_filename_in2 = './images/ex_faceswap/02/frame001692.jpg'
...
def main():
    ...
    return
# ---------------------------------------------------------------------------------------------------------------------
def demo_live_stable(filename_out):
...
def demo_live(filename_out):
    ...
    image1 = cv2.imread(prefix+filename1)
    image2 = cv2.imread(prefix+filename2)
    L1_original = D.get_landmarks(image1)[49:]
    del_triangles = Delaunay(L1_original).vertices
    L2_original = D.get_landmarks(image2)[49:]
...
if __name__ == '__main__':
    ...
    #demo_auto()
    process_folder(default_filename_in,default_folder_in,default_folder_out)
